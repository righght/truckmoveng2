// export function setIcons(L) {
  L.Icon.Default.prototype.options.iconUrl = "assets/img/marker-icon.png";
  L.Icon.Default.prototype.options.shadowUrl = "assets/img/marker-shadow.png";
  L.Icon.Default.prototype.options.iconRetinaUrl = "assets/img/marker-icon-2x.png";

  // ------------ Defining function for creating icons with A,B,... letters -----------------------------
